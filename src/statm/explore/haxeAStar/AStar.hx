...
class AStar
{
	...
	public function findPath(start:IntPoint, dest:IntPoint):Array<IntPoint>
	{
	...
	inline private function getPath():Array<IntPoint>
	{
		var path:Array<IntPoint> = new Array<IntPoint>();
	...
	private function searchPath():Array<IntPoint>
	{
